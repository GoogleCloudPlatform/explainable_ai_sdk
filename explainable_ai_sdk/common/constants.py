...
XSERVER_SIMILARITY = "similarity"
XSERVER_ATTR_EXPLAINER = "attribution_explainer"
XSERVER_SIM_EXPLAINER = "similarity_explainer"
XSERVER_PROFILING = "runtime_profiling"

# Constant strings used in response formatting
...
SL_EXPLAIN_PREP_DATA = ("explain-prep_step_data",)
SL_EXPLAIN_PREP_EVAL_EXP_TENSORS = ("explain-evaluate_explained_tensors",)
SL_EXPLAIN_PREP_EVAL_OUT_RES = ("explain-evaluate_outputs_response",)
SL_EXPLAIN_LABEL_ATTRIBUTIONS = ("explain-compute_label_attributions",)
SL_EXPLAIN_LABEL_ATTRIBUTIONS_VIA_STRATEGY_RAW = (
    *SL_EXPLAIN_LABEL_ATTRIBUTIONS,
    "_compute_attributions_via_strategy-compute_raw_attributions")
SL_EXPLAIN_LABEL_ATTRIBUTIONS_VIA_STRATEGY_EXPLAINED_TENSORS = (
    *SL_EXPLAIN_LABEL_ATTRIBUTIONS,
    "_compute_attributions_via_strategy-prep_explained_tensors")
SL_EXPLAIN_LABEL_ATTRIBUTIONS_VIA_STRATEGY_LABELD = (
    *SL_EXPLAIN_LABEL_ATTRIBUTIONS,
    "_compute_attributions_via_strategy-compute_label_attributions")

SL_SHAPLEY_PREP_SOLVER = (
    *SL_EXPLAIN_LABEL_ATTRIBUTIONS_VIA_STRATEGY_RAW,
    "SampledShapley-calculate_baselines_attributions-prep_solver")
...
SL_SHAPLEY_CC_PREP_SOLVER = (
    *SL_EXPLAIN_LABEL_ATTRIBUTIONS_VIA_STRATEGY_RAW,
    "SampledShapleyCC-calculate_baselines_attributions-prep_solver")
...
GREEN_COLORMAP = [[0.0, 0.0, 0.0], [0.0, 38.952755905, 0.0],
...
VIRIDIS_COLORMAP = [[68, 1, 84], [68, 2, 85], [68, 3, 87], [69, 5, 88],
                    ...
                    [50, 98, 141], [50, 99, 141],
                    [49, 100, 141], [49, 101, 141], [49, 102, 141],
                    [48, 103, 141], [48, 104, 141], [47, 105, 141],
                    [47, 106, 141], [46, 107, 142], [46, 108, 142],
                    [46, 109, 142], [45, 110, 142], [45, 111, 142],
                    [44, 112, 142], [44, 113, 142], [44, 114, 142],
                    [43, 115, 142], [43, 116, 142], [42, 117, 142],
                    [42, 118, 142], [42, 119, 142], [41, 120, 142],
                    [41, 121, 142], [40, 122, 142], [40, 122, 142],
                    [40, 123, 142], [39, 124, 142], [39, 125, 142],
                    [39, 126, 142], [38, 127, 142], [38, 128, 142],
                    [38, 129, 142], [37, 130, 142], [37, 131, 141],
                    [36, 132, 141], [36, 133, 141], [36, 134, 141],
                    [35, 135, 141], [35, 136, 141], [35, 137, 141],
                    [34, 137, 141], [34, 138, 141], [34, 139, 141],
                    [33, 140, 141], [33, 141, 140], [33, 142, 140],
                    [32, 143, 140], [32, 144, 140], [32, 145, 140],
                    [31, 146, 140], [31, 147, 139], [31, 148, 139],
                    [31, 149, 139], [31, 150, 139], [30, 151, 138],
                    [30, 152, 138], [30, 153, 138], [30, 153, 138],
                    [30, 154, 137], [30, 155, 137], [30, 156, 137],
                    [30, 157, 136], [30, 158, 136], [30, 159, 136],
                    [30, 160, 135], [31, 161, 135], [31, 162, 134],
                    [31, 163, 134], [32, 164, 133], [32, 165, 133],
                    [33, 166, 133], [33, 167, 132], [34, 167, 132],
                    [35, 168, 131], [35, 169, 130], [36, 170, 130],
                    [37, 171, 129], [38, 172, 129], [39, 173, 128],
                    [40, 174, 127], [41, 175, 127], [42, 176, 126],
                    [43, 177, 125], [44, 177, 125], [46, 178, 124],
                    [47, 179, 123], [48, 180, 122], [50, 181, 122],
                    [51, 182, 121], [53, 183, 120], [54, 184, 119],
                    [56, 185, 118], [57, 185, 118], [59, 186, 117],
                    [61, 187, 116], [62, 188, 115], [64, 189, 114],
                    [66, 190, 113], [68, 190, 112], [69, 191, 111],
                    [71, 192, 110], [73, 193, 109], [75, 194, 108],
                    [77, 194, 107], [79, 195, 105], [81, 196, 104],
                    [83, 197, 103], [85, 198, 102], [87, 198, 101],
                    [89, 199, 100], [91, 200, 98], [94, 201, 97], [96, 201, 96],
                    [98, 202, 95], [100, 203, 93], [103, 204,
                                                    92], [105, 204, 91],
                    [107, 205, 89], [109, 206, 88], [112, 206, 86],
                    [114, 207, 85], [116, 208, 84], [119, 208, 82],
                    [121, 209, 81], [124, 210, 79], [126, 210, 78],
                    [129, 211, 76], [131, 211, 75], [134, 212, 73],
                    [136, 213, 71], [139, 213, 70], [141, 214, 68],
                    [144, 214, 67], [146, 215, 65], [149, 215, 63],
                    [151, 216, 62], [154, 216, 60], [157, 217, 58],
                    [159, 217, 56], [162, 218, 55], [165, 218, 53],
                    [167, 219, 51], [170, 219, 50], [173, 220, 48],
                    [175, 220, 46], [178, 221, 44], [181, 221, 43],
                    [183, 221, 41], [186, 222, 39], [189, 222, 38],
                    [191, 223, 36], [194, 223, 34], [197, 223, 33],
                    [199, 224, 31], [202, 224, 30], [205, 224, 29],
                    [207, 225, 28], [210, 225, 27], [212, 225, 26],
                    [215, 226, 25], [218, 226, 24], [220, 226, 24],
                    [223, 227, 24], [225, 227, 24], [228, 227, 24],
                    [231, 228, 25], [233, 228, 25], [236, 228, 26],
                    [238, 229, 27], [241, 229, 28], [243, 229, 30],
                    [246, 230, 31], [248, 230, 33], [250, 230, 34],
                    [253, 231, 36]]

PINK_COLORMAP = [
    [RED_COLORMAP[i][0], 0, RED_COLORMAP[i][0]] for i in range(0, 256)
]
...
COLOR_MAPS = {
    "red_green": {
        "positive": GREEN_COLORMAP,
        "negative": RED_COLORMAP
    },
    "red": {
        "positive": RED_COLORMAP,
        "negative": RED_COLORMAP
    },
    "green": {
        "positive": GREEN_COLORMAP,
        "negative": GREEN_COLORMAP
    },
    "viridis": {
        "positive": VIRIDIS_COLORMAP,
        "negative": VIRIDIS_COLORMAP
    },
    "pink_white_green": {
